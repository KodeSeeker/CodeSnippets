...
/**
Given a string remove b's from the string and replace a with dd's, WITHOUT using extra memory.

Key : Trivial task without extra memory. 
However, without any extra buffer, we need to anticipate final string length before performing writes. 
